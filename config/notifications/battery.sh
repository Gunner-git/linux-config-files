...
echo "Low Battery notification sent" && $(paplay .config/notifications/sounds/clearly.ogg) || \
...
echo "Full Battery notification sent" && $(paplay .config/notifications/sounds/clearly.ogg) || \
